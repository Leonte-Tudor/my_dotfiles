...
#define COLOR (#001000 * (dx/60 + 0) + #000100 * (dy/30) + #ff217c) 
/* Angle (in radians) for how much to rotate the visualizer */
#define ROTATE (PI + 0.6)
...
#define CENTER_OFFSET_Y 319
/* Offset (X) of the visualization */
#define CENTER_OFFSET_X 596

/* Gravity step, override from `smooth_parameters.glsl` */
#request setgravitystep 15.0
